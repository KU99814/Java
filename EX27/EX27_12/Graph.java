...
public interface Graph
{
 ...
 public boolean add(Object vertex);//加入vertex

 public boolean remove(Object vertex);//移除vertex
 
 public boolean add(Edge edge);//加入edge

 public boolean remove(Edge edge);//移除edge
