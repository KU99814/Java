 ...
 public static void main(String[] args)
  {
   ...
   WeightedGraph.MST tree1 = graph1.getMinimumSpanningTree();//原本的MST
   WeightedGraph.MST tree1_1 = graph1.getMinimumSpanningTreeByKruskal();//Kruskal's algorithm
   ...
   //顯示Kruskal's algorithm MST
   System.out.println("Tree1_1:Total weight is "+tree1_1.getTotalWeight());
   tree1_1.printTree();
   System.out.println();
   ...
   WeightedGraph.MST tree2 = graph2.getMinimumSpanningTree(1);//原本的MST

   WeightedGraph.MST tree2_1 = graph2.getMinimumSpanningTreeByKruskal();//Kruskal's algorithm
   ...
   //顯示Kruskal's algorithm MST
   System.out.println("Tree2_1:Total weight is "+tree2_1.getTotalWeight());
   tree2_1.printTree();
