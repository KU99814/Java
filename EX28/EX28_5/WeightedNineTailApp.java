...
public class WeightedNineTailApp extends JFrame
{
 ...
 private WeightedNineTailModel model = new WeightedNineTailModel();//nine tail物件

 //default
 public WeightedNineTailApp()
  {
   ...
   jbtSolve.addActionListener(new ActionListener(){
    public void actionPerformed(ActionEvent e){
     ...
     //取得解答路徑    
     java.util.List<WeightedNineTailModel.Node> list = 
        model.getShortestPath(new WeightedNineTailModel.Node(initialNodePanel.getMatrix()));
    
     //創建並加入node panel 將每一個解答繪出
     for(WeightedNineTailModel.Node node: list)
