//implementing Dijkstra's algorithm using adjacency matrix
 ...
 public static void main(String[] args)
  {
   ...
   WeightedGraph.ShortestPathTree tree1 = graph1.getShortestPath(5);//從第5vertex開始的最短路徑
   tree1.printAllPaths();//顯示到所有點的路徑和cost
   ...
   WeightedGraph.ShortestPathTree tree2 = graph2.getShortestPath(3);//從第3vertex開始的最短路徑
   tree2.printAllPaths();//顯示到所有點的路徑和cost
  }
}