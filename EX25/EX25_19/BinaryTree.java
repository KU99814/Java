...
public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E>
{
 ...
 public boolean insert(E e)
  {
   if(root == null)//若樹為空 直接設為root 
   ...
   else
    {
     ...
     //依大小判斷加為左或右子樹 同時在新node中加入parent node
 ...
 public TreeNode<E> getParent(TreeNode<E> node)
  {
   return node.parent;//回傳parent node
  }
 ...
 public java.util.ArrayList<TreeNode<E>> findLeaf()
  {
   ...
   java.util.ArrayList<TreeNode<E>> list = 
    new java.util.ArrayList<TreeNode<E>>();//儲存leaf node
 ...
 public java.util.ArrayList<TreeNode<E>> getPath(TreeNode<E> node)
  {
   ...
   TreeNode<E> current = node;//目前node

   //迴圈直到node為null
   while(current != null)
    {
     list.add(0,current);//加為最前面
     
     current = getParent(current);//將目前node變為parent node
    }
