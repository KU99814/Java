 ...
 public void addFirst(E e)
  {
   ...
   newNode.next = head;//將next指向head

   if(size != 0)//若list不為空 將head prev指向新node
    head.prev = newNode;
   head = newNode;//設新node為head
   size++;//大小+1
 ...
 public void addLast(E e)
  {
   ...
   if(tail == null)
    ...
    {
     tail.next = newNode;//將tail node next指向新node
     newNode.prev = tail;//新node prev指向tail
